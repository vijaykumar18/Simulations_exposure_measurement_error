...
#
# Experiment: # Experiment 2 (E2): All scenarios from E1, but with a positive systematic shift
# c = +0.25 added to the error mean (i.e., v ~ N(+0.25, sigma^2)).
# This models high-risk individuals being systematically over-assigned exposure.
#
# Outputs : All CSV results saved to ./exp/exp_002/Results/
################################################################################
...
cat("\nAll scenarios complete. Results saved to ./exp/exp_002/Results/\n")
sessionInfo()
