...
#
# Output  : exp/exp_003/Results/diff_null_moreErr.csv
#           exp/exp_003/Results/cor_diff_null_moreErr.csv
################################################################################
...
log_file <- "./exp/exp_003/sims4_log.txt"

start_time <- Sys.time()

cat("Script: sims4.R (exp_003)\n", file = log_file)
...
write_csv(diff.null.moreErr,
          "./exp/exp_003/Results/diff_null_moreErr.csv")
