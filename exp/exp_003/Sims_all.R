################################################################################
# Sims_all.R  —  Run all 10 simulation scenarios for Experiment  (E)
#
...
#
# Experiment: # Experiment 3 (E3): All scenarios from E1, but with a negative systematic shift
# c = -0.25 added to the error mean (i.e., v ~ N(-0.25, sigma^2)).
# This models high-risk individuals being systematically under-assigned exposure.
#
# Outputs : All CSV results saved to ./exp/exp_003/Results/
################################################################################
...
cat("\nAll scenarios complete. Results saved to ./exp/exp_003/Results/\n")
sessionInfo()
