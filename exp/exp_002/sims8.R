...
# Output  : exp/exp_002/Results/diff_harm_moreErr.csv
#           exp/exp_002/Results/cor_diff_harm_moreErr.csv
################################################################################
...
log_file <- "./exp/exp_002/sims8_log.txt"

start_time <- Sys.time()

cat("Script: sims8.R (exp_002)\n", file = log_file)
...
write_csv(diff.harm.moreErr,
          "./exp/exp_002/Results/diff_harm_moreErr.csv")

write_csv(cor.diff.harm.moreErr,
          "./exp/exp_002/Results/cor_diff_harm_moreErr.csv")
