...
#
# Output  : exp/exp_003/Results/diff_null_lessErr.csv
#           exp/exp_003/Results/cor_diff_null_lessErr.csv
################################################################################
...
log_file <- "./exp/exp_003/sims3_log.txt"

start_time <- Sys.time()

cat("Script: sims3.R (exp_003)\n", file = log_file)
...
write_csv(diff.null.lessErr,
          "./exp/exp_003/Results/diff_null_lessErr.csv")
