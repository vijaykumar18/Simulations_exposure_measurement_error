...
# Output  : exp/exp_003/Results/diff_harm_lessErr50.csv
#           exp/exp_003/Results/cor_diff_harm_lessErr50.csv
################################################################################
##################### Vijay's simulations ##############################
...
log_file <- "./exp/exp_003/sims9_log.txt"

start_time <- Sys.time()

cat("Script: sims9.R (exp_003)\n", file = log_file)
...
write_csv(diff.harm.lessErr50,
          "./exp/exp_003/Results/diff_harm_lessErr50.csv")
