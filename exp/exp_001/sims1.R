...
#
# Output  : exp/exp_001/Results/nondiff_null.csv
#           exp/exp_001/Results/cor_nondiff_null.csv
################################################################################
...
log_file <- "./exp/exp_001/sims1_log.txt"
...
################################################################################
# Scenario 1 — NON-DIFFERENTIAL ERROR, NULL DATA  sims1.R
# Each simulation adds the same N(0, sigma^2) noise to every observation,
# regardless of PTB status.  Four error magnitudes are tested (err.lev).
# Results matrix: columns alternate beta / SE for each error level.
################################################################################
...
##################### Save results ###################################
# Same naming scheme as all experiments
