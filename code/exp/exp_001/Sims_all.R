...
# Save files
write_csv(diff.null.moreErr, "./exp/exp_001/Results/diff_null_moreErr.csv")
write_csv(cor.diff.null.moreErr, "./exp/exp_001/Results/cor_diff_null_moreErr.csv")
...
# Save files
write_csv(diff.harm.lessErr, "./exp/exp_001/Results/diff_harm_lessErr.csv")
write_csv(cor.diff.harm.lessErr, "./exp/exp_001/Results/cor_diff_harm_lessErr.csv")
...
# Save results
write_csv(diff.harm.lessErr50, "./exp/exp_001/Results/diff_harm_lessErr50.csv")
write_csv(cor.diff.harm.lessErr50, "./exp/exp_001/Results/cor_diff_harm_lessErr50.csv")
...
# Save results
write_csv(diff.harm.moreErr50, "./exp/exp_001/Results/diff_harm_moreErr50.csv")
write_csv(cor.diff.harm.moreErr50, "./exp/exp_001/Results/cor_diff_harm_moreErr50.csv")
