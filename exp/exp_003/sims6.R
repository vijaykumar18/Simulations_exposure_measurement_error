...
# Output  : exp/exp_003/Results/diff_null_moreErr50.csv
#           exp/exp_003/Results/cor_diff_null_moreErr50.csv
################################################################################
...
log_file <- "./exp/exp_003/sims6_log.txt"

start_time <- Sys.time()

cat("Script: sims6.R (exp_003)\n", file = log_file)
...
write_csv(diff.null.moreErr50,
          "./exp/exp_003/Results/diff_null_moreErr50.csv")
