...
#
# Output  : exp/exp_002/Results/diff_null_lessErr50.csv
#           exp/exp_002/Results/cor_diff_null_lessErr50.csv
################################################################################
...
log_file <- "./exp/exp_002/sims5_log.txt"

start_time <- Sys.time()

cat("Script: sims5.R (exp_002)\n", file = log_file)
...
write_csv(diff.null.lessErr50,
          "./exp/exp_002/Results/diff_null_lessErr50.csv")

write_csv(cor.diff.null.lessErr50,
          "./exp/exp_002/Results/cor_diff_null_lessErr50.csv")
