...
# Output  : exp/exp_003/Results/diff_harm_moreErr.csv
#           exp/exp_003/Results/cor_diff_harm_moreErr.csv
################################################################################
...
log_file <- "./exp/exp_003/sims8_log.txt"

start_time <- Sys.time()

cat("Script: sims8.R (exp_003)\n", file = log_file)
...
write_csv(diff.harm.moreErr,
          "./exp/exp_003/Results/diff_harm_moreErr.csv")
