...
# Output  : exp/exp_002/Results/diff_harm_lessErr.csv
#           exp/exp_002/Results/cor_diff_harm_lessErr.csv
################################################################################
...
log_file <- "./exp/exp_002/sims7_log.txt"

start_time <- Sys.time()

cat("Script: sims7.R (exp_002)\n", file = log_file)
...
write_csv(diff.harm.lessErr,
          "./exp/exp_002/Results/diff_harm_lessErr.csv")
