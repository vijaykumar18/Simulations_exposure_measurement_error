...
#
# Output  : exp/exp_002/Results/nondiff_harm.csv
#           exp/exp_002/Results/cor_nondiff_harm.csv
################################################################################
...
log_file <- "./exp/exp_002/sims2_log.txt"

start_time <- Sys.time()

cat("Script: sims2.R (exp_002)\n", file = log_file)
...
for (s in 1:n.sims){
  ...
  for (e in 1:length(err.lev)){
    ...
    # Mismeasured exposure (biased error)
