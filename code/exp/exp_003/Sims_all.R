...
# Save
write_csv(diff.null.lessErr, "./exp/exp_003/Results/diff_null_lessErr.csv")
write_csv(cor.diff.null.lessErr, "./exp/exp_003/Results/cor_diff_null_lessErr.csv")
...
# Save files
write_csv(diff.null.moreErr, "./exp/exp_003/Results/diff_null_moreErr.csv")
write_csv(cor.diff.null.moreErr, "./exp/exp_003/Results/cor_diff_null_moreErr.csv")
...
# Save output
write_csv(diff.null.lessErr50, "./exp/exp_003/Results/diff_null_lessErr50.csv")
write_csv(cor.diff.null.lessErr50, "./exp/exp_003/Results/cor_diff_null_lessErr50.csv")
...
# Save
write_csv(diff.null.moreErr50, "./exp/exp_003/Results/diff_null_moreErr50.csv")
write_csv(cor.diff.null.moreErr50, "./exp/exp_003/Results/cor_diff_null_moreErr50.csv")
...
# Save files
write_csv(diff.harm.lessErr, "./exp/exp_003/Results/diff_harm_lessErr.csv")
write_csv(cor.diff.harm.lessErr, "./exp/exp_003/Results/cor_diff_harm_lessErr.csv")
...
# Save results
write_csv(diff.harm.moreErr50, "./exp/exp_003/Results/diff_harm_moreErr50.csv")
write_csv(cor.diff.harm.moreErr50, "./exp/exp_003/Results/cor_diff_harm_moreErr50.csv")
