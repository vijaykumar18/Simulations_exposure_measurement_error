...
# Output  : exp/exp_002/Results/diff_harm_moreErr50.csv
#           exp/exp_002/Results/cor_diff_harm_moreErr50.csv
################################################################################
...
log_file <- "./exp/exp_002/sims10_log.txt"

start_time <- Sys.time()

cat("Script: sims10.R (exp_002)\n", file = log_file)
...
write_csv(diff.harm.moreErr50,
          "./exp/exp_002/Results/diff_harm_moreErr50.csv")
