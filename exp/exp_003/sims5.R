...
#
# Output  : exp/exp_003/Results/diff_null_lessErr50.csv
#           exp/exp_003/Results/cor_diff_null_lessErr50.csv
################################################################################
...
log_file <- "./exp/exp_003/sims5_log.txt"

start_time <- Sys.time()

cat("Script: sims5.R (exp_003)\n", file = log_file)
...
write_csv(diff.null.lessErr50,
          "./exp/exp_003/Results/diff_null_lessErr50.csv")
