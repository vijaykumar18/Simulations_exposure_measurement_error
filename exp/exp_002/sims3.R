...
#
# Output  : exp/exp_002/Results/diff_null_lessErr.csv
#           exp/exp_002/Results/cor_diff_null_lessErr.csv
################################################################################
...
log_file <- "./exp/exp_002/sims3_log.txt"

start_time <- Sys.time()

cat("Script: sims3.R (exp_002)\n", file = log_file)
...
write_csv(diff.null.lessErr,
          "./exp/exp_002/Results/diff_null_lessErr.csv")

write_csv(cor.diff.null.lessErr,
          "./exp/exp_002/Results/cor_diff_null_lessErr.csv")
